const Dashboard = () => {
  return (
    <div className="md:p-2">
      ...
      <div
        className="md:bg-white md:h-50 sm:h-80 h-screen md:border-1 
                  md:shadow-sm border-gray-300 rounded-xl grid
                  md:grid-cols-4 sm:grid-cols-2 grid-cols-1 p-3 gap-3 "
      >
        <div className="bg-linear-to-br from-slate-900 via-slate-800 to-slate-900  cursor-pointer hover:scale-103 duration-400 transition  rounded-xl shadow-lg px-5 py-4">
